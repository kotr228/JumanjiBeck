...
router.post('/add', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield db_1.default.promise().query('INSERT INTO favoritesdrinks (user_id, drinks_id) VALUES (?, ?)', [userId, dishId]);
...
router.post('/remove', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, dishId } = req.body;
    try {
        yield db_1.default.promise().query('DELETE FROM favoritesdrinks WHERE user_id = ? AND drinks_id = ?', [userId, dishId]);
